        ...
        <div className="nd-container">
          ...
          <div className="nd-domain-selector">
            {domains.map(domain => (
              ...
              >
                <span className="nd-domain-icon">{domain.icon}</span>
                ...
                <div className="nd-strengths-section">
                  ...
                  <div>
                    {currentData.neurotypical.strengths.map((strength, index) => (
                      <span key={index} className="nd-strength-badge neurotypical">{strength}</span>
                    ))}
                  </div>
                </div>
              </div>
                ...
                <div className="nd-strengths-section">
                  ...
                  <div>
                    {currentData.neurodivergent.strengths.map((strength, index) => (
                      <span key={index} className="nd-strength-badge neurodivergent">{strength}</span>
                    ))}
                  </div>
                </div>
              </div>
