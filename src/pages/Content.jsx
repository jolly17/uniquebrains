...
function Content() {
  ...
  const [activeSection, setActiveSection] = useState('neurodiversity')
    ...
    <div className="content-page">
      <div className="content-container">
        ...
        <div className="section-nav">
          <button
            className={`section-nav-btn ${activeSection === 'neurodiversity' ? 'active' : ''}`}
            onClick={() => setActiveSection('neurodiversity')}
          >
            🧠 Understanding Neurodiversity
          </button>
          {/* Placeholder for future sections */}
          <button className="section-nav-btn" disabled style={{ opacity: 0.5, cursor: 'not-allowed' }}>
            📖 More Coming Soon
          </button>
        </div>

        {/* Neurodiversity Section */}
        {activeSection === 'neurodiversity' && (
